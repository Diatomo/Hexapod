...
class Ax12:
    ...
    def __init__(self):
        if(Ax12.port == None):
            try:
                Ax12.port = Serial("/dev/ttyACM0", baudrate=1000000, timeout=1)
            except:
                Ax12.port = Serial("/dev/ttyACM1", baudrate=1000000, timeout=1)
        if(not Ax12.gpioSet):
    ...
    def learnServos(self,minValue=1, maxValue=6, verbose=False) :
        ...
        for i in range(minValue, maxValue + 1):
            try :
                ...
                if verbose : print("Error pinging servo #" + str(i) + ': ' + str("dont worry"))
                pass
        return servoList
